...
class SyncWallpaper extends StatefulWidget {
  const SyncWallpaper({Key? key}) : super(key: key);

  @override
  State<SyncWallpaper> createState() => _MyAppState();
}

class _MyAppState extends State<SyncWallpaper> {
  ...
  String url = 'https://images.pexels.com/photos/15746995/pexels-photo-15746995/free-photo-of-nha-c-a-nha-nau-m-c-m-c.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load';
